    ...
    e.fn.perfectScrollbar = function (n, r) {
        return this.each(function () {
            ...
            var s, i, c, d, u, p, f, v, h, b, g = e("<div class='ps-scrollbar-x-rail'></div>").appendTo(a),
                ...
                T = e("<div class='ps-scrollbar-y'></div>").appendTo(m), L = parseInt(g.css("bottom"), 10), y = L === L,
                I = y ? null : parseInt(g.css("top"), 10), S = parseInt(m.css("right"), 10), C = S === S,
                x = C ? null : parseInt(m.css("left"), 10), D = "rtl" === a.css("direction"), X = o(),
